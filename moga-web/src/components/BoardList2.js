...
const mfData = [
    {name: '학과 게시판', link: '/main/board/major', title: '학과 게시물 제목1'},
    {name: '자유 게시판', link: '/main/board/free', title: '자유 게시물 제목1'},
];
            ...
            <div className="board-wrap">
                ...
                <List
                    ...
                    renderItem={item => (
                        <List.Item>
                            <Link to={item.link}>
                                <span className="board-title bold">{item.name}</span>
                                <span className="board-data-mf">{item.title}</span>
                            </Link>
                        </List.Item>
                    )}
                />
